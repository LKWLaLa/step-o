class StepsController < ApplicationController
  ...
  def step_params
    params.require(:step).permit(:name, :user_id, :level_of_mastery, :notes, style_ids: [], :video_ids => [], timemarkers_attributes: [:id, :marker, video_attributes: [:id, :user_id, :url, :title, :notes, :year]])
  end
